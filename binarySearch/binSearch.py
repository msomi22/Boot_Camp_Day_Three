...
class BinarySearch(list):
    ...
    def __init__(self, listlen, interval):
    	pass
        
    def __new__(self,listlen,interval):
        self.array = range(interval,listlen+1,interval)
...
print one_to_twenty.search
#one_to_twenty.search(one_to_twenty, 16)




'''
print one_to_twenty.array
print one_to_twenty.length
print one_to_twenty.array[0]
print one_to_twenty.array[19]
print one_to_twenty.array[one_to_twenty.length]
...
import unittest
class BinarySearchTest(unittestTestCase):
